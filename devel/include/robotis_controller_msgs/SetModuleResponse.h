...
bool operator==(const ::robotis_controller_msgs::SetModuleResponse_<ContainerAllocator1> & lhs, const ::robotis_controller_msgs::SetModuleResponse_<ContainerAllocator2> & rhs)
{
