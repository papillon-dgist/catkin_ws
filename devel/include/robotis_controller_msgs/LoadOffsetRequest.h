...
bool operator==(const ::robotis_controller_msgs::LoadOffsetRequest_<ContainerAllocator1> & lhs, const ::robotis_controller_msgs::LoadOffsetRequest_<ContainerAllocator2> & rhs)
{
